...
const OPERATOR_NAME = "김현주";
const CONTACT_EMAIL = "khjoo1203@naver.com";
    ...
    <main className="mx-auto max-w-3xl px-6 py-12 text-gray-800">
      ...
      <section id="s2" className="mb-10 scroll-mt-20">
        ...
        <div className="mb-4">
          ...
          <ul className="list-disc space-y-1 pl-6 leading-relaxed">
            ...
            <li><strong>필수 항목</strong>: 이메일 주소, 비밀번호(단방향 암호화하여 저장, 원문 보관하지 않음)</li>
          </ul>
        </div>
        <div>
      ...
      <section id="s4" className="mb-10 scroll-mt-20">
        ...
        <ul className="list-disc space-y-2 pl-6 leading-relaxed">
          <li><strong>파기 절차</strong>: 이용자의 회원 탈퇴 요청 또는 보유기간 만료 시 즉시 파기</li>
      ...
      <section id="s7" className="mb-10 scroll-mt-20">
        ...
        <ul className="list-disc space-y-2 pl-6 leading-relaxed">
          ...
          <li><strong>물리적 조치</strong>: 국제 보안 인증(SOC2 등)을 획득한 클라우드 인프라를 대한민국 리전에서 활용</li>
        </ul>
      </section>

      <section id="s8" className="mb-10 scroll-mt-20">
        <h2 className="mb-4 text-xl font-bold">8. 개인정보 자동 수집 장치(쿠키)의 설치·운영 및 거부</h2>
        <p className="mb-3 leading-relaxed">
          {SERVICE_NAME}은 로그인 상태 유지 및 이용자 맞춤 서비스
          제공을 위해 쿠키(cookie)를 사용합니다.
        </p>
        <ul className="list-disc space-y-2 pl-6 leading-relaxed">
          <li><strong>사용 목적</strong>: 로그인 세션 유지, 이용자 환경 설정 저장</li>
          <li>
            <strong>거부 방법</strong>: 웹브라우저 설정 &gt; 개인정보 보호 및 보안 메뉴에서 쿠키 저장을 거부할 수 있습니다.
      ...
      <section id="s10" className="mb-10 scroll-mt-20">
        ...
        <ul className="list-disc space-y-1 pl-6 leading-relaxed">
          <li>개인정보분쟁조정위원회: (국번없이) 1833-6972 (<a href="https://www.kopico.go.kr" target="_blank" rel="noreferrer noopener" className="text-blue-600 underline">www.kopico.go.kr</a>)</li>
          <li>개인정보침해신고센터: (국번없이) 118 (<a href="https://privacy.kisa.or.kr" target="_blank" rel="noreferrer noopener" className="text-blue-600 underline">privacy.kisa.or.kr</a>)</li>
          <li>대검찰청: (국번없이) 1301 (<a href="https://www.spo.go.kr" target="_blank" rel="noreferrer noopener" className="text-blue-600 underline">www.spo.go.kr</a>)</li>
          <li>경찰청: (국번없이) 182 (<a href="https://ecrm.cyber.go.kr" target="_blank" rel="noreferrer noopener" className="text-blue-600 underline">ecrm.cyber.go.kr</a>)</li>
        </ul>
      </section>
